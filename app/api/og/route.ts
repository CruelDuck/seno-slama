    ...
    (
      ...
      >
        <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: 24 }}>
          <div style={{
            width: 40, height: 40, borderRadius: 8, background: 'linear-gradient(90deg,#fde68a,#f59e0b)',
        ...
        {badge && (
          <div style={{
            display:'inline-flex', fontSize: 20, padding: '6px 12px',
            borderRadius: 999, background: '#ecfdf5', color: '#065f46',
            border: '1px solid #10b981', marginBottom: 18, width: 'fit-content'
          }}>
            {badge}
          </div>
        )}
