  ...
  return (
    <div className="card p-4 sticky top-4">
      <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-3">
        ...
        <input className="input" placeholder="Kraj" value={get('kraj')} onChange={e=>setParam('kraj', e.target.value)} />
        <input className="input" placeholder="Okres" value={get('okres')} onChange={e=>setParam('okres', e.target.value)} />
